...
!character(len=max_varname_length),public, dimension(9) :: vars3d_supported =
character(len=max_varname_length),public, dimension(15) :: vars3d_supported = (/'u   ', 'v   ', 't ', 'q   ','delp', 'oz  ', 'cw  ', 'tsen', 'prse','ql  ','qr  ','qi  ','qs  ','qg  ','w   '/)
