...
!   2021-10-25  X. Lu and X. Wang - skip cloudy_radiance_info.txt for GOES ABI,
!               OffLine Bias Correction will be performed inside setuprad.f90 
